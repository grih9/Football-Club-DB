...
# Form implementation generated from reading ui file 'ui/newCoach.ui'
#
...
"}")
        ...
        self.enterButton.setGeometry(QtCore.QRect(200, 480, 491, 61))
        font = QtGui.QFont()
        ...
        self.birthdayLine.setMinimumDateTime(QtCore.QDateTime(QtCore.QDate(1920, 1, 1), QtCore.QTime(0, 0, 0)))
        self.birthdayLine.setMaximumDate(QtCore.QDate(2001, 12, 11))
        self.birthdayLine.setMinimumDate(QtCore.QDate(1920, 1, 1))
        ...
        self.workLine = QtWidgets.QLineEdit(self.groupBox)
        self.workLine.setGeometry(QtCore.QRect(580, 210, 275, 50))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(12)
        self.workLine.setFont(font)
        self.workLine.setText("")
        self.workLine.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.myTeamCheckBox.setGeometry(QtCore.QRect(40, 210, 221, 41))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        ...
        self.workLabel = QtWidgets.QLabel(self.groupBox)
        self.workLabel.setGeometry(QtCore.QRect(610, 160, 221, 41))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(18)
        self.workLabel.setFont(font)
        self.workLabel.setStyleSheet("color: rgb(220, 220, 220);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "НОВЫЙ РАБОТНИК"))
        self.enterButton.setText(_translate("MainWindow", "ДОБАВИТЬ РАБОТНИКА"))
