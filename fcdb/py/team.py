...
"color: rgb(0, 0, 0)")
        ...
        self.allPlayersRadio = QtWidgets.QRadioButton(self.players)
        self.allPlayersRadio.setGeometry(QtCore.QRect(30, 15, 95, 20))
        self.allPlayersRadio.setObjectName("allPlayersRadio")
        self.goalkeepersRadio = QtWidgets.QRadioButton(self.players)
        self.goalkeepersRadio.setGeometry(QtCore.QRect(110, 15, 95, 20))
        self.goalkeepersRadio.setObjectName("goalkeepersRadio")
        self.defRadio = QtWidgets.QRadioButton(self.players)
        self.defRadio.setGeometry(QtCore.QRect(210, 15, 95, 20))
        self.defRadio.setObjectName("defRadio")
        self.midRadio = QtWidgets.QRadioButton(self.players)
        self.midRadio.setGeometry(QtCore.QRect(330, 15, 121, 20))
        self.midRadio.setObjectName("midRadio")
        self.forwardRadio = QtWidgets.QRadioButton(self.players)
        self.forwardRadio.setGeometry(QtCore.QRect(470, 15, 121, 20))
        self.forwardRadio.setObjectName("forwardRadio")
        self.injCheckBox = QtWidgets.QCheckBox(self.players)
        self.injCheckBox.setGeometry(QtCore.QRect(600, 15, 101, 20))
        self.injCheckBox.setObjectName("injCheckBox")
        self.injJournalButton = QtWidgets.QPushButton(self.players)
        self.injJournalButton.setGeometry(QtCore.QRect(802, 10, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(9)
        self.injJournalButton.setFont(font)
        self.injJournalButton.setObjectName("injJournalButton")
        self.noPlayersLabel = QtWidgets.QLabel(self.players)
        self.noPlayersLabel.setGeometry(QtCore.QRect(120, 190, 741, 81))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(25)
        self.noPlayersLabel.setFont(font)
        self.noPlayersLabel.setStyleSheet("color: rgb(255, 129, 129);")
        self.noPlayersLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.noPlayersLabel.setObjectName("noPlayersLabel")
        ...
        self.contractsTabel.setGeometry(QtCore.QRect(10, 60, 971, 431))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(11)
        ...
        self.changeButton = QtWidgets.QPushButton(self.contracts)
        self.changeButton.setGeometry(QtCore.QRect(870, 15, 101, 28))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(9)
        self.changeButton.setFont(font)
        self.changeButton.setObjectName("changeButton")
        self.allRadio = QtWidgets.QRadioButton(self.contracts)
        self.allRadio.setGeometry(QtCore.QRect(40, 20, 95, 20))
        self.allRadio.setObjectName("allRadio")
        self.expiredRadio = QtWidgets.QRadioButton(self.contracts)
        self.expiredRadio.setGeometry(QtCore.QRect(160, 20, 95, 20))
        self.expiredRadio.setObjectName("expiredRadio")
        self.playersContractsCombo = QtWidgets.QComboBox(self.contracts)
        self.playersContractsCombo.setGeometry(QtCore.QRect(610, 15, 241, 31))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(9)
        self.playersContractsCombo.setFont(font)
        self.playersContractsCombo.setObjectName("playersContractsCombo")
        self.noContractrsLabel = QtWidgets.QLabel(self.contracts)
        self.noContractrsLabel.setGeometry(QtCore.QRect(120, 190, 741, 81))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(25)
        self.noContractrsLabel.setFont(font)
        self.noContractrsLabel.setStyleSheet("color: rgb(255, 129, 129);")
        self.noContractrsLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.noContractrsLabel.setObjectName("noContractrsLabel")
        ...
        self.youngRadio = QtWidgets.QRadioButton(self.fans)
        self.youngRadio.setGeometry(QtCore.QRect(350, 10, 150, 20))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        self.youngRadio.setFont(font)
        self.youngRadio.setObjectName("youngRadio")
        self.maleRadio = QtWidgets.QRadioButton(self.fans)
        self.maleRadio.setGeometry(QtCore.QRect(530, 10, 95, 20))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        self.maleRadio.setFont(font)
        self.maleRadio.setObjectName("maleRadio")
        self.femaleRadio = QtWidgets.QRadioButton(self.fans)
        self.femaleRadio.setGeometry(QtCore.QRect(655, 10, 95, 20))
        self.femaleRadio.setObjectName("femaleRadio")
        self.resetButton = QtWidgets.QPushButton(self.fans)
        self.resetButton.setGeometry(QtCore.QRect(810, 10, 93, 28))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        self.resetButton.setFont(font)
        self.resetButton.setObjectName("resetButton")
        self.noFansLabel_3 = QtWidgets.QLabel(self.fans)
        self.noFansLabel_3.setGeometry(QtCore.QRect(120, 190, 741, 81))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(25)
        self.noFansLabel_3.setFont(font)
        self.noFansLabel_3.setStyleSheet("color: rgb(255, 129, 129);")
        self.noFansLabel_3.setAlignment(QtCore.Qt.AlignCenter)
        self.noFansLabel_3.setObjectName("noFansLabel_3")
        self.defB = QtWidgets.QRadioButton(self.fans)
        self.defB.setGeometry(QtCore.QRect(30, 10, 95, 20))
        self.defB.setText("")
        self.defB.setObjectName("defB")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.allPlayersRadio.setText(_translate("MainWindow", "Все"))
        self.goalkeepersRadio.setText(_translate("MainWindow", "Вратари"))
        self.defRadio.setText(_translate("MainWindow", "Защитники"))
        self.midRadio.setText(_translate("MainWindow", "Полузащитники"))
        self.forwardRadio.setText(_translate("MainWindow", "Нападающие"))
        self.injCheckBox.setText(_translate("MainWindow", "Здоровые"))
        self.injJournalButton.setText(_translate("MainWindow", "ЖУРНАЛ ТРАВМ"))
        self.noPlayersLabel.setText(_translate("MainWindow", "Таких игроков нет!"))
        ...
        self.expiredRadio.setText(_translate("MainWindow", "Истекают"))
        self.noContractrsLabel.setText(_translate("MainWindow", "Таких игроков нет!"))
        ...
        self.youngRadio.setText(_translate("MainWindow", "Юные болельщики"))
        self.maleRadio.setText(_translate("MainWindow", "Мужчины"))
        self.femaleRadio.setText(_translate("MainWindow", "Женщины"))
        self.resetButton.setText(_translate("MainWindow", "CБРОС"))
        self.noFansLabel_3.setText(_translate("MainWindow", "Таких болельщиков нет!"))
