...
"}")
        ...
        self.profileButton.setStyleSheet(" color: rgb(255, 129, 129)")
        ...
        font.setItalic(False)
        font.setWeight(75)
        self.managingButton.setFont(font)
        self.managingButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.managingButton.setStyleSheet(" color: rgb(220, 220, 220);")
        icon = QtGui.QIcon.fromTheme("NO")
        self.managingButton.setIcon(icon)
        self.managingButton.setIconSize(QtCore.QSize(300, 300))
        self.managingButton.setObjectName("managingButton")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.managingButton.setText(_translate("MainWindow", "УПРАВЛЕНИЕ"))
