...
# Form implementation generated from reading ui file 'ui/menuFan.ui'
#
...
"}")
        ...
        self.teamButton.setGeometry(QtCore.QRect(260, 40, 291, 91))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        ...
        self.ticketsButton = QtWidgets.QCommandLinkButton(self.groupBox)
        self.ticketsButton.setGeometry(QtCore.QRect(220, 150, 371, 91))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(30)
        font.setBold(True)
        ...
        self.ticketsButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.ticketsButton.setStyleSheet(" color: rgb(220, 220, 220);")
        icon = QtGui.QIcon.fromTheme("NO")
        self.ticketsButton.setIcon(icon)
        self.ticketsButton.setIconSize(QtCore.QSize(300, 300))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.teamButton.setText(_translate("MainWindow", "КОМАНДА"))
        self.ticketsButton.setText(_translate("MainWindow", "МОИ БИЛЕТЫ"))
